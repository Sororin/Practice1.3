...
read_excel('C:/Users/user/Desktop/R class/Data/reef_fish.xlsx') # automatically print on my screen
fish<-read_excel('C:/Users/user/Desktop/R class/Data/reef_fish.xlsx') # store my table in an object called `fish`
fish # print my object `fish`   

# importing a .txt file
fish<-read.table('C:/Users/user/Desktop/R class/Data/reef_fish.txt', header=T, sep='\t', dec='.') 
